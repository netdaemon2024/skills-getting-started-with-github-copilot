...
activities = {
    ...
    "Art Studio": {
        "description": "Create paintings, drawings, and sculptures with guidance from experienced instructors",
    ...
    "Science Club": {
        "description": "Explore science through experiments and STEM projects",
